...
resource "aws_lambda_function" "s3_lambda" {
    ...
    s3_key = "sources/lambda/functions/zipfiles/${var.lambda1_name}_function.zip"
...
resource "aws_lambda_function" "opencv_lambda" {
    ...
    s3_bucket = var.bucket
    s3_key = "sources/lambda/functions/zipfiles/${var.lambda2_name}_function.zip"
...
resource "aws_lambda_layer_version" "opencv_layer" {
    ...
    s3_bucket = var.bucket
    s3_key = "sources/lambda/functions/zipfiles/layers/opencv-python-layer-py36.zip"
...
resource "aws_lambda_layer_version" "pydicom_layer" {
    ...
    s3_bucket = var.bucket
    s3_key = "sources/lambda/functions/zipfiles/layers/pydicom-layer-py37.zip"
...
resource "aws_lambda_layer_version" "numpy_layer" {
    ...
    s3_bucket = var.bucket
    s3_key = "sources/lambda/functions/zipfiles/layers/numpy-layer-py37.zip"
